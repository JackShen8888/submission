...
public class SimpleDisplay {
    ...
    public static void main(String[] args) {
        MovingTruck truck = new MovingTruck(2000, 2500, 4000, Size.LARGE);//卡车

        Storage storage1 = new Box(200, 200, 200, "A box of something");//箱子
        Personal personal1 = new Laptop("Thomas", 2);//机器人
        Personal personal2 = new Clothes("Lucy", Size.SMALL, ClotheType.SHIRT);//人
        Personal personal3 = new Clothes("Lucy", Size.SMALL, ClotheType.SHIRT);//人
        Furniture furniture1 = new Furniture(FurnitureType.CHAIR);//家具-椅子
        try {
